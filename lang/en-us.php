...
$lang['301'] = "Your script does not appear to exist at that location. Your root folder is: ".$useraccount['ac_user_vc']."";
...
$lang['316'] = "<b>ERROR:</b> The entry exists in the database, but ".$_POST['upatehtaccess'].".htpasswd htaccess file cannot be found in the selected directory.<br><br>Delete and recreate this directory entry to generate a new htaccess file.";
...
$lang['334'] = "<b>DELETED HTACCESS ENTRY:</b> ".$ht_id_pk.".htpasswd <b>FROM:</b> ";
$lang['335'] = "<b>ADDED USER FOR DIRECTORY:</b> ";
$lang['336'] = "'<b>ERROR:</b> Passwords do not match!";
$lang['337'] = "<b>DELETED USER:</b> ".$user." <b>FROM HTPASSWD ENTRY</b> ".$ht_id_pk.".htpasswd";
